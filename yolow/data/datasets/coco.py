# Modify from https://github.com/open-mmlab/mmdetection/blob/main/mmdet/datasets/coco.py
# Apache-2.0 license
import copy
...
class CocoDataset(BaseDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        """  # noqa: E501
        self.coco = COCO(annotation_file=self.ann_file)
        # The order of returned `cat_ids` will not
        # change with the order of the `classes`
        self.cat_ids = self.coco.getCatIds(cat_names=self.metainfo['classes'])
